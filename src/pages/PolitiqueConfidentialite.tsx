            ...
            <Card className="bg-background shadow-soft border-0 mb-8">
              <CardContent className="p-8">
                <div className="space-y-4 text-muted-foreground leading-relaxed text-justify">
                  <p>
                    La présente politique de confidentialité a pour objet de vous donner une meilleure visibilité sur le traitement 
                    de vos données à caractère personnel (ci-après les « Données »). Il est rappelé que, conformément à la réglementation 
