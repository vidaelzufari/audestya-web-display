        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
              Structuration et accompagnement juridique de vos réseaux de distribution
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="font-serif text-3xl md:text-4xl font-bold text-primary-foreground mb-6">
              Développez Votre Réseau en Toute Sécurité
            </h2>
            <p className="text-xl text-primary-foreground/90 leading-relaxed mb-8 max-w-3xl mx-auto">
              Bénéficiez d'un accompagnement juridique expert pour structurer et développer 
